...
def copytree(src, dst, symlinks=False, ignore=None):
    ...
    :param symlinks: preserve symlinks (from shutil.copytree)
    :param ignore: filtering callable (from shutil.copytree)

    Implemenation based on the copytree example:

      http://docs.python.org/2/library/shutil.html#copytree-example
    """
